...
def main():
    ...
    try:
        ...
        red_results = cube_pose_detector.get_transforms([cv_image, point_cloud], 'red cube')
        ...
        # Get Transforms for Red Cube
        green_results = cube_pose_detector.get_transforms([cv_image, point_cloud], 'green cube')
