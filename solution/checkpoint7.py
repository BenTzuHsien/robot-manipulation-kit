from solution.checkpoint6 import get_transform_cube
...
from solution.checkpoint1 import grasp_cube, GRIPPER_LENGTH
from solution.checkpoint2 import place_in_basket, BASKET_POSE
